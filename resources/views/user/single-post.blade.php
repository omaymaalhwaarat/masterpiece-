      ...
      <div class="container">
        <div class="row text-center">
          <div class="post-meta text-uppercase my-3">
            <span class="post-category">Fashion</span> / <span class="meta-date">12 jan, 2023</span>
          </div>
          <h1 class="post-title text-uppercase">
            <a href="single-post.html">Follow the make-up trend for summer</a>
          </h1>
            ...
            <article class="post-item">
              ...
              <div class="post-content py-5">
                <div class="post-description">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consectetur facilisis vivamus massa magna.
                    Blandit mauris libero condimentum commodo morbi consectetur sociis convallis sit. Magna diam amet
                    justo sed vel dolor et volutpat integer. Iaculis sit sapien hac odio elementum egestas neque.
                    Adipiscing purus euismod orci sem amet, et. Turpis erat ornare nisi laoreet est euismod.</p>
                  ...
                  <div class="row my-4">
                    <div class="col-md-6">
                      <img src="images/single-image1.jpg" alt="post-image" class="align-left">
                      <h4>Velit, praesent pharetra malesuada</h4>
                    </div>
                    <div class="col-md-6">
                      <img src="images/single-image2.jpg" alt="post-image" class="align-right">
                      <h4>Velit, praesent pharetra malesuada</h4>
                    </div>
                  </div>
                ...
                <div id="single-post-navigation">
                  <div class="post-navigation d-flex justify-content-between">
                    <a itemprop="url" class="post-prev" href="">
                      ...
                      <span class="page-nav-title text-uppercase">Top 10 make-up trend for summer</span>
                    </a>
                    <a itemprop="url" class="post-next" href="">
                      <span class="page-nav-title text-uppercase">Skin care tips for teens</span>
                    ...
                    <form method="post" class="form-group padding-small">
                      <div class="row">
                        ...
                        <div class="col-lg-12 mt-3">
                          <button class="btn btn-lg btn-primary text-uppercase btn-rounded-none w-100"
        ...
        <aside class="col-md-3">
          <div class="post-sidebar">
            <form role="search" method="get" action="" class="mb-5">
              <div class="wp-block-search d-flex border-0">
                <input type="search" class="form-control border focus-ring-light" name="s" value="" placeholder="Search"
                  required="">
                ...
                <div class="row my-3">
                  ...
                  <div class="col-md-8">
                    <div class="sidebar-post-content text-uppercase">
                      ...
                      <h6 class="post-title">
                        <a href="#">Top 10 minimal makeup looks for womens</a>
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div class="row my-3">
                  ...
                  <div class="col-md-8">
                    <div class="sidebar-post-content text-uppercase">
                      ...
                      <h6 class="post-title">
                        <a href="#">Summer skincare for women</a>
                      </h6>
                    </div>
                  </div>
                </div>
            ...
            <div class="widget sidebar-social-links border-animation-left">
              ...
              <ul class="list-unstyled d-flex gap-3 m-0 lh-1">
                <li>
                  <a href="#" class="text-secondary p-0">
                    <svg width="18" height="18">
                      <use xlink:href="#facebook"></use>
  ...
  <section class="blog my-5 py-5">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        <h4 class="text-uppercase">Related Blog Posts</h4>
      </div>
      <div class="row">
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase  text-secondary">
                ...
                <span class="meta-day"> jul 11, 2023</span>
              </div>
